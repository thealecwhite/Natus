...
namespace PowerTools
{
	...
	public class SpriteAnimNodes : MonoBehaviour
	{
		...
		public Vector3 GetPosition(int nodeId)
		{
			...
			result.y = -result.y;
			result = result * (1.0f / m_spriteRenderer.sprite.pixelsPerUnit);
		...
		public float GetAngle(int nodeId)
		{
			...
			if (m_spriteRenderer.transform.lossyScale.x < 0)
				angle = (180.0f - angle) * m_spriteRenderer.transform.lossyScale.x;
